...
class MoeBot:
    ...
    def __init__(self, device_id: str, device_ip: str, local_key: str) -> None:
        ...
        self.__battery: int = 0
        self.__state = None
        self.__emergency_state = None
        self.__error_state = None
        self.__mow_in_rain: bool = None
        self.__mow_time: int = 0
        self.__password = None
        self.__work_mode: bool = False
    ...
    def __bitmap_to_list(self, value):
        ...
        active_errors = []
        for i, name in enumerate(ERROR_KEYS):
            if value & (1 << i):
    ...
    def cover_open(self) -> bool:
        return self.__cover_open

    @property
    def hedgehog_protection(self) -> bool:
        return self.__hedgehog_protection
