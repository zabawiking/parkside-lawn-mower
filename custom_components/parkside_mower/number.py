...
from .pymoebot2 import ZoneConfig, MoeBot
...
class WorkingTimeNumber(BaseMoeBotEntity, NumberEntity):
    ...
    def __init__(self, moebot):
        ...
        self._attr_unique_id = f"{self._moebot.id}_mow_time"
        self._attr_entity_category = EntityCategory.CONFIG

        self._attr_has_entity_name = True
        self._attr_translation_key = "mow_time"
...
class ZoneConfigNumber(BaseMoeBotEntity, NumberEntity):
    def __init__(self, moebot: MoeBot, zone: int, part: ZoneNumberType):
        ...
        self._attr_device_class = NumberDeviceClass.DISTANCE if self.part == ZoneNumberType.DISTANCE else 0
    ...
    def set_native_value(self, value: float) -> 0:
